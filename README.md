...
3. **Pick element**, then click the thing on the page you care about. The popup reopens with a
   selector filled in, and tells you how many elements it matches.
4. Choose whether to blip when it **appears** or when it **is gone**, name your topic, and save.
5. Saving asks the browser for access to that one site. Blipr cannot watch a site you have not
   allowed, so declining means the watch is not saved.
